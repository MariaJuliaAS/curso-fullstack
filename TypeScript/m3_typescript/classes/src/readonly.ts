...
class Pessoa{
    readonly id: string = '123'; //se colocasse private ia conseguir alterar dentro da classe, então colocamos o readony pq pode ser acessado mas não pode ser alterado
    nome: string;
    idade: number;
